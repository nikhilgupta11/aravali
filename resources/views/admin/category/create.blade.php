        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">Add Category
                    <a class="btn btn-primary btn-sm float-end" href="{{route('admin.category.index')}}" enctype="multipart/form-data"> Back</a>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.category.store')}}" id="add-data" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row mb-6">
                                    <label class="col-sm-4 col-label-form">Category Name:<span class="required">*</span></label>
                                    <div class="col-sm-7">
