        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-success float-end" href="{{ route('admin.district.create') }}"> <i class="fa fa-plus" aria-hidden="true"></i> Create District</a>
                </div>
