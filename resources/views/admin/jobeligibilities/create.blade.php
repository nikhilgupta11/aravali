...
<div class="content-wrapper">
  ...
  <div class="content-header">
      <div class="container-fluid">
          <div class="card">
              <div class="card-header">Add Job Eligibility
                  <a class="btn btn-primary btn-sm float-end" href="{{route('admin.jobeligibilities.index')}}" enctype="multipart/form-data"> Back</a>
              </div>
              <div class="card-body">
                  <form action="{{route('admin.jobeligibilities.store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="row">
                          <div class="col-sm-12">
                              ...
                              <div class="row mb-6 mt-2">
                                <label class="col-sm-4 col-label-form">Eligibility Name:<span class="required">*</span></label>
                                <div class="col-sm-7">
