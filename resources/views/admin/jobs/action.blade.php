<a href="{{ route('admin.jobs.show',$id) }}" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-success edit">
    <i class='fa fa-eye'></i>
    </a>
<a href="{{ route('admin.jobs.edit',$id) }}" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-success edit">
...
function divFunction(clicked_id){
    ...
    var id = $(this).attr('id');
     ...
     var url =    "{{ url('admin/get-district') }}";
